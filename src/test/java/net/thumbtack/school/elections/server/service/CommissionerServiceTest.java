...
public class CommissionerServiceTest {
    ...
    public void loginTest_Success() {
        ...
        when(commissionerService.getSessionService().loginCommissioner(anyString())).thenReturn(gson.toJson(new LoginCommissionerDtoResponse("1")));
        assertEquals(gson.toJson(new LoginCommissionerDtoResponse("1")), commissionerService.login(gson.toJson(new LoginDtoRequest("victor.net", "25345Qw&&"))));
    }

    @Test
    public void loginTest_Field_Not_Valid() {
        when(commissionerService.getContextService().isElectionStart()).thenReturn(false);
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.LOGIN_NOT_VALID.getMessage())), commissionerService.login(gson.toJson(new LoginDtoRequest("net", "25345Qw&&"))));
    }

    @Test
    public void loginTest_Not_Found() {
        when(commissionerService.getContextService().isElectionStart()).thenReturn(false);
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NOT_FOUND.getMessage())), commissionerService.login(gson.toJson(new LoginDtoRequest("1111111111", "25345Qw&&"))));
    }
    ...
    public void loginTest_Pass_Not_Valid() {
        when(commissionerService.getContextService().isElectionStart()).thenReturn(false);
        when(commissionerService.getSessionService().loginCommissioner(anyString())).thenReturn(gson.toJson(new LoginCommissionerDtoResponse("1")));
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.WRONG_PASSWORD.getMessage())), commissionerService.login(gson.toJson(new LoginDtoRequest("victor.net", "25345Q1@q2423"))));
    }

    @Test
    public void loginTest_Json_Is_Null() {
        when(commissionerService.getContextService().isElectionStart()).thenReturn(false);
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.login(null));
    }

    @Test
    public void loginTest_Election_Already_Start() {
        when(commissionerService.getContextService().isElectionStart()).thenReturn(true);
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.ELECTION_START.getMessage())), commissionerService.login(randomString()));
    }

    @Test
    public void isCommissionerTest_Success() {
        assertTrue(commissionerService.isCommissioner(gson.toJson(new IsCommissionerDtoRequest("victor.net", "25345Q1@q2423"))));
    }
    ...
    public void logoutTest_Field_Not_Valid() throws ServerException {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.logout(gson.toJson(new LogoutDtoRequest(null))));
    ...
    public void logoutTest_Json_Is_Null() throws ServerException {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.logout(null));
        verify(commissionerService.getSessionService(), times(0)).logoutCommissioner(anyString());
    }
    ...
    public void startElectionTest_Success() throws ServerException {
        ...
        when(commissionerService.getSessionService().getCommissioner(anyString())).thenReturn(gson.toJson(new GetCommissionerDtoResponse(commissioner)));
    ...
    public void startElectionTest_Not_Chairman() throws ServerException {
        ...
        when(commissionerService.getSessionService().getCommissioner(anyString())).thenReturn(gson.toJson(new GetCommissionerDtoResponse(commissioner)));
        when(commissionerService.getElectionService().startElection(anyString())).thenReturn("");
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NOT_CHAIRMAN.getMessage())), commissionerService.startElection(gson.toJson(new StartElectionDtoRequest(randomString()))));
    ...
    public void startElectionTest_Field_Not_Valid() {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.startElection(gson.toJson(new StartElectionDtoRequest(null))));
        verify(commissionerService.getElectionService(), times(0)).startElection(anyString());
    }

    @Test
    public void startElectionTest_Json_Is_Null() {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.startElection(null));
        verify(commissionerService.getElectionService(), times(0)).startElection(anyString());
    }
    ...
    public void getElectionResultTest_Success() throws ServerException {
        Commissioner commissioner = new Commissioner("victor.net", "25345Qw&&", true);
        when(commissionerService.getSessionService().getCommissioner(anyString())).thenReturn(gson.toJson(new GetCommissionerDtoResponse(commissioner)));
        when(commissionerService.getElectionService().getElectionResult()).thenReturn(gson.toJson(new GetElectionResultDtoResponse(new HashSet<>())));
        assertEquals(gson.toJson(new GetElectionResultDtoResponse(new HashSet<>())), commissionerService.getElectionResult(gson.toJson(new GetElectionResultDtoRequest(randomString()))));
    ...
    public void getElectionResultTest_Not_Chairman() throws ServerException {
        ...
        when(commissionerService.getSessionService().getCommissioner(anyString())).thenReturn(gson.toJson(new GetCommissionerDtoResponse(commissioner)));
        when(commissionerService.getElectionService().getElectionResult()).thenReturn(gson.toJson(new GetElectionResultDtoResponse(new HashSet<>())));
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NOT_CHAIRMAN.getMessage())), commissionerService.getElectionResult(gson.toJson(new GetElectionResultDtoRequest(randomString()))));
        verify(commissionerService.getElectionService(), times(0)).getElectionResult();
    }

    @Test
    public void getElectionResultTest_Field_Not_Valid() {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.getElectionResult(gson.toJson(new GetElectionResultDtoRequest(null))));
        verify(commissionerService.getElectionService(), times(0)).getElectionResult();
    }

    @Test
    public void getElectionResultTest_Json_Is_Null() {
        assertEquals(gson.toJson(new ErrorDtoResponse(ExceptionErrorCode.NULL_VALUE.getMessage())), commissionerService.getElectionResult(null));
        verify(commissionerService.getElectionService(), times(0)).getElectionResult();
    }
